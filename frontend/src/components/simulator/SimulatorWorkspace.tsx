 ...
 * `RocketConfigFormProvider` (o `RocketConfig` agregado) e
 * `SimulationProvider` (o estado da chamada a `POST /simulate`). Os
 * painéis permanecem montados (ocultos via `hidden`, não desmontados)
 * para que o visualizador 2D/3D preserve seu estado ao trocar de aba. */
