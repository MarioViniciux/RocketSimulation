    ...
    <div className="flex flex-col gap-6">
      ...
      <fieldset className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          />
          <NumberField name="structure.nose_cone.length_m" label="Comprimento" unit="m" />
          <NumberField name="structure.nose_cone.mass_kg" label="Massa" unit="kg" />
        </div>
      </fieldset>
      ...
      <fieldset className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
          <NumberField name="structure.fins.count" label="Quantidade" unit="un" step={1} />
          <NumberField
            name="structure.fins.mounting_angle_deg"
            label="Angulação de montagem"
            unit="graus"
          />
          <NumberField name="structure.fins.root_chord_m" label="Corda de raiz" unit="m" />
          <NumberField name="structure.fins.tip_chord_m" label="Corda de ponta" unit="m" />
          <NumberField
